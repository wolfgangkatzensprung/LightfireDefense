...
/// <summary>
/// A simple free camera to be added to a Unity game object.     // slightly modified
/// 
/// Keys:
...
public class FreeCam : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (looking)
        {
            ...
            transform.localEulerAngles = Vector3.SmoothDamp(transform.localEulerAngles, targetRotation, ref currentVelocity, smoothTime: .3f);
        }
